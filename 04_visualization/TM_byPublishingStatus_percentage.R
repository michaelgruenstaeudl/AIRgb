...
plotData$TOTAL <- c(filter(plotData, IS_PUBLISHED == FALSE)$TOTAL / sum(filter(plotData, IS_PUBLISHED == FALSE)$TOTAL), filter(plotData, IS_PUBLISHED == TRUE)$TOTAL / sum(filter(plotData, IS_PUBLISHED == TRUE)$TOTAL))
